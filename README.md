...
- 🎓 Estudiante de Ingeniería Civil Informática en la Universidad Técnica Federico Santa María.
...
Aplicación móvil desarrollada con Flutter para explorar, buscar y consultar
...
- Búsqueda y persistencia de consultas.
- Navegación entre pantallas.
- Carga progresiva de contenido.
- Diseño adaptable para dispositivos móviles.

**Tecnologías:** Flutter, Dart, Riverpod y The Movie Database API.

[![Repositorio](https://img.shields.io/badge/Ver_repositorio-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/SSJorge/cinemapedia)

---

### 📦 Plataforma de gestión de pedidos

Sistema full-stack para registrar, administrar y consultar pedidos desde
...
- Código público para consultar el estado de un pedido.
- Integración con un bot de Telegram.
- Despliegue del frontend en Vercel y del backend en Render.

**Tecnologías:** React, Go, PostgreSQL, Vite, Telegram Bot API, Vercel y Render.

[![Repositorio](https://img.shields.io/badge/Ver_repositorio-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/SSJorge/pedidos-react-go-postgres)

---

## Objetivo profesional

Mi objetivo es especializarme en el desarrollo de aplicaciones móviles
multiplataforma y trabajar como desarrollador freelance.

Me interesa participar en proyectos relacionados con:

- Aplicaciones móviles para negocios y emprendimientos.
- MVP para validar ideas de productos.
- Integraciones con APIs y servicios externos.
- Sistemas de autenticación y bases de datos.
- Aplicaciones conectadas con paneles web, bots y notificaciones.

---

## Actualmente estoy aprendiendo

- Arquitecturas escalables para aplicaciones Flutter.
- Manejo de estado avanzado con Riverpod.
- Persistencia local utilizando SQLite y Drift.
- Pruebas, optimización y mantenimiento de aplicaciones.
- Publicación y distribución de aplicaciones para Android e iOS.
...
¿Tienes una idea para una aplicación o proyecto digital?

[![LinkedIn](https://img.shields.io/badge/Contactarme_por_LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/jorge-moreno-torres/)
